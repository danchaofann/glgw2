...
public class ProductModelAdapter extends BaseQuickAdapter<ProductModelBean, BaseViewHolder> {
    public ProductModelAdapter(int layoutResId, @Nullable List<ProductModelBean> data) {
