...
public class ContractDetailsActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void setListener() {
        ...
        mTvApprovalRejected.setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_approved:
                showApproved();
                break;
            case R.id.tv_approval_rejected:
                showReason();
                break;
        }
    }
    ...
    private void showReason() {
        View view = LayoutInflater.from(mActivity).inflate(R.layout.dialog_refuse, null);
    ...
    private void showApproved() {
        View view = LayoutInflater.from(mActivity).inflate(R.layout.dialog_prompt2, null);
        TextView tv_cancel=view.findViewById(R.id.tv_cancel);
        TextView tv_sure = view.findViewById(R.id.tv_sure);
