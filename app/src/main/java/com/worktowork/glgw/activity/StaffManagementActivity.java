...
import com.worktowork.glgw.fragment.StaffManagementFragment;
...
public class StaffManagementActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        for (int i = 0; i < mTitleDataList.length; i++) {
            fragmentList.add(StaffManagementFragment.newInstance(mTitleDataList[i],""));
        }

        mViewHome.setOffscreenPageLimit(mTitleDataList.length);
        mViewHome.setAdapter(new MyPagerAdapter(getSupportFragmentManager(), mTitleDataList, fragmentList));
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                colorTransitionPagerTitleView.setSelectedColor(Color.parseColor("#FFFF6600"));
//                colorTransitionPagerTitleView.setTextColor(Color.parseColor("#666666"));
                ...
                colorTransitionPagerTitleView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        mViewHome.setCurrentItem(index);
                    }
                });
...
//                indicator.setLineWidth(100);
        ...
        ViewPagerHelper.bind(mMagic, mViewHome);
