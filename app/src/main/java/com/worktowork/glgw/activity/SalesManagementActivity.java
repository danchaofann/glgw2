...
import com.worktowork.glgw.fragment.SalesManagementFragment;
...
//销售管理
public class SalesManagementActivity extends BaseActivity implements View.OnClickListener {
    @BindView(R.id.view)
    View mView;
    ...
    protected void initData() {
        for (int i = 0; i < mTitleDataList.length; i++) {
            mWorkOrderFragmentList.add(SalesManagementFragment.newInstance(mTitleDataList[i], ""));
        }
