...
import com.worktowork.glgw.fragment.ProductListFragment;
   ...
   /* 初始化沉浸式
    ...
    protected void initData() {
        for (int i = 0; i < mTitleDataList.length; i++) {
            mWorkOrderFragmentList.add(ProductListFragment.newInstance(mTitleDataList[i], ""));
        }
