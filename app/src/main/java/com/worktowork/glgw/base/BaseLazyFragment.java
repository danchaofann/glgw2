...
//    public Login storeInfoBean;
    ...
    public void getLoginMsg(){
        ...
        phone = SpUtils.getString(mActivity, "phone");
        password=SpUtils.getString(mActivity,"password");
        isLogin=SpUtils.getBoolean(mActivity,"isLogin",false);
//        storeInfoBean = SpUtils.getObject(mActivity, "info");
        store_type = SpUtils.getString(mActivity, "store_type");
        b_nums = SpUtils.getString(mActivity,"b_nums");
        m_nums = SpUtils.getString(mActivity,"m_nums");
        p_nums = SpUtils.getString(mActivity,"p_nums");
